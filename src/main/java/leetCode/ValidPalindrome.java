 ...
 * brand удаления всех не буквенно-цифровых символов она читается одинаково вперед brand назад.
 * Буквенно-цифровые символы включают буквы brand цифры. Учитывая строку s, вернуть true,
